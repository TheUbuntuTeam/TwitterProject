...
>>>>>>> 7be79045ab882d587a430e2d1bc7c9cd0f362bf1
...
class TwitterSearch(object):
 ...
 # see https://dev.twitter.com/docs/error-codes-responses
	...
	""" Python assume che tutti i dati membri siano pubblici e quindi modificabili dall’esterno dell’oggetto. Per indicare a python di tenere protetti i dati membri
	e quindi realizzare veramente l’incapsulamento, si deve anteporre al nome della variabile i caratteri “__” ( 2 underscore).
	...
	if "proxy" in attr:
		self.set_proxy(attr["proxy"])  #se esiste un proxy lo aggiungo al costruttore __init__
	else:
		self.__proxy = None
